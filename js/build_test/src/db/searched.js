...
let SearchResult = class extends FirestoreRecord {
  static from(input) {
...
SearchResult.collectionName = "searchResults";
SearchResult.patchedFields = [
  "query",
  "response"
];
__decorateClass([
...
], SearchResult.prototype, "query", 2);
__decorateClass([
  Prop({
    required: true
  })
], SearchResult.prototype, "queryDigest", 2);
__decorateClass([
  Prop()
], SearchResult.prototype, "response", 2);
__decorateClass([
  Prop()
], SearchResult.prototype, "createdAt", 2);
__decorateClass([
  Prop()
], SearchResult.prototype, "expireAt", 2);
